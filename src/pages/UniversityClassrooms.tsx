...
import { ArrowLeft, Building2, Users, MapPin, Eye, Edit, Trash2, Plus } from "lucide-react";
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-muted-foreground mt-2">
            {classrooms.length} amphithéâtre{classrooms.length > 1 ? 's' : ''} dans cette université
          </p>
        </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">
                  {classrooms.filter(c => c.status === 'active' || !c.status).length}
                </p>
              </div>
            </div>
          </CardContent>
                ...
                <div className="space-y-3">
                  {classroom.capacity && (
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="font-medium">{classroom.capacity} places</span>
                    </div>
                  )}
                  ...
                  {(classroom.lat && classroom.lng) && (
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="text-muted-foreground">
                        {typeof classroom.lat === 'string' ? parseFloat(classroom.lat).toFixed(4) : classroom.lat?.toFixed(4)}, {typeof classroom.lng === 'string' ? parseFloat(classroom.lng).toFixed(4) : classroom.lng?.toFixed(4)}
                      </span>
                    </div>
                  )}
